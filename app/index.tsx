...
const DECK_IDS = ['briefing', 'intelligence', 'operations', 'chat', 'dave', 'organizer', 'research', 'routines', 'memory', 'selfheal', 'dock'];
...
export default function DashboardScreen() {
  ...
  const widgets = useMemo<WidgetSpec[]>(() => {
    const specs: WidgetSpec[] = [
      ...
      {
        id: 'memory',
        title: t('mod.memory.title', language),
        desc: t('mod.memory.desc', language),
        icon: <Brain size={15} color={palette.accent} />,
        borderColor: palette.accent,
        onPress: () => {
          haptics.light();
          router.push('/memory');
