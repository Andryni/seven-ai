...
| Feature | Status |
|---|---|
| Gideon / HUD / Terminal UI | ✅ Volumetric SVG avatar with perspective and accelerometer parallax, layered facial anatomy, blinking/saccades and text-driven EN/FR viseme lip-sync (including jaw, lips, teeth and tongue). This is GPU-composited 2.5D, not a falsely advertised photorealistic 3D mesh. |
